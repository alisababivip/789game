...
const d = j("assert.ts", {
    ...
    b = `[${E.npmPackageName}@${E.projectVersion}]`,
    _e = `${b}[Bug]`,
    Pe = `${b}[Wrong Usage]`,
    Ne = `${b}[Warning]`,
    je = `${b}[Info]`,
...
function U(e, t, {
    ...
    if (n) {
        ...
        if (o.has(l)) return;
        o.add(l)
    }(r = d.onBeforeLog) === null || r === void 0 || r.call(d)
}
...
function We(e, t, {
    ...
    if (n) {
        ...
        if (a.has(o)) return;
        a.add(o)
    }(i = d.onBeforeLog) === null || i === void 0 || i.call(d)
}
    ...
    return Object.entries(n).sort(Ve(([r]) => r === "default")).forEach(([r, a]) => {
        ...
        if (o)
            if (De(t)) r = "Page";
                ...
                g(w(a), `The \`export default\` of ${t} should be an object.`), Object.entries(a).forEach(([l, u]) => {
                    qe(l, t), i.push({
                        exportName: l,
                        exportValue: u,
...
function nt(e) {
    ...
    L(e.pageFilesLazy).forEach(({
        ...
        r = t[i] = (o = t[i]) !== null && o !== void 0 ? o : r;
        const l = a;
        s(w(l)), s(p(l, "exportNames", "string[]"), r.filePath), r.exportNames = l.exportNames
...
function L(e) {
    ...
    return Object.entries(e).forEach(([n, i]) => {
        s(Xe.includes(n)), s(w(i)), Object.entries(i).forEach(([r, a]) => {
            const o = se(r);
...
function gt(e) {
    s("exports" in e), s("exportsAll" in e), s("pageExports" in e), s(w(e.pageExports));
...
export {
    lt as A, Ze as B, he as C, z as D, ge as E, yt as F, ut as G, rt as H, be as I, j as a, g as b, R as c, s as d, b as e, W as f, Re as g, ke as h, Q as i, p as j, U as k, O as l, ee as m, w as n, A as o, H as p, it as q, K as r, N as s, le as t, ot as u, q as v, We as w, Ae as x, gt as y, pt as z
};