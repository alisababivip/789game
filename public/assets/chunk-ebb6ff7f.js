    u = c.jsx("svg", {
        viewBox: "0 0 32 32",
        xmlns: "http://www.w3.org/2000/svg",
        children: c.jsx("path", {
            d: "M16.005 28.133c6.702 0 12.135-5.433 12.135-12.135s-5.433-12.135-12.135-12.135c-6.702 0-12.135 5.433-12.135 12.135v0c0.008 6.699 5.436 12.127 12.134 12.135h0.001zM16.005 2.002c7.73 0.003 13.996 6.27 13.996 14 0 7.732-6.268 14-14 14s-14-6.268-14-14c0-0.002 0-0.003 0-0.005v0c0.010-7.73 6.275-13.994 14.005-14h0.001zM16.941 15.993l4.11 4.11c0.135 0.161 0.217 0.371 0.217 0.6 0 0.517-0.419 0.936-0.936 0.936-0.229 0-0.438-0.082-0.601-0.218l0.001 0.001-4.668-4.652v-7.882c0-0.517 0.419-0.936 0.936-0.936s0.936 0.419 0.936 0.936v0z"
        })
    }),
    f = c.jsx("svg", {
        viewBox: "0 0 32 32",
    ...
    b = c.jsx("svg", {
        ...
        xmlns: "http://www.w3.org/2000/svg",
        children: c.jsx("path", {
            d: "M17.388 17.534v0h-2.777v-7.511c0-0.317-0.257-0.574-0.574-0.574s-0.574 0.257-0.574 0.574v0 8.090c0 0.009 0 0.019 0 0.028 0.001 0.029 0.004 0.057 0.009 0.084l-0-0.004c0.005 0.021 0.010 0.039 0.016 0.056l-0.001-0.003c0.005 0.021 0.011 0.039 0.018 0.056l-0.001-0.003c0.007 0.018 0.017 0.033 0.025 0.051s0.017 0.033 0.027 0.049c0.012 0.017 0.023 0.032 0.036 0.045l-0-0c0.012 0.014 0.021 0.027 0.033 0.040 0.022 0.021 0.045 0.041 0.069 0.059l0.002 0.001 0.014 0.011 2.642 1.807h-8.957v-13.816h6.060v0.842c0 0.317 0.257 0.574 0.574 0.574s0.574-0.257 0.574-0.574v0-3.702h9.982l-4.269 6.984 4.269 6.834zM17.388 19.708l-1.493-1.022h1.493zM22.348 10.695l3.693-6.037c0.175-0.265 0.278-0.589 0.278-0.938 0-0.95-0.77-1.72-1.72-1.72-0 0-0.001 0-0.001 0h-9.989c-0.95 0-1.721 0.77-1.721 1.721v0 1.141h-5.488c-0 0-0.001 0-0.001 0-0.95 0-1.72 0.77-1.72 1.72v0 22.559c0 0.475 0.385 0.86 0.86 0.86s0.86-0.385 0.86-0.86v-7.023h9.982c0.951-0.001 1.721-0.771 1.721-1.722 0 0 0 0 0 0v0-1.141h5.489c0 0 0 0 0.001 0 0.95 0 1.72-0.77 1.72-1.72 0-0.338-0.098-0.653-0.266-0.919l0.004 0.007z"
        })
    }),
    B = c.jsx("svg", {
        viewBox: "0 0 32 32",
...
let S = [{
    ...
    x = localStorage.getItem("emojiHistory");
x && (i.history = m(x.split(",")));
const E = ({
        onChange: e
    }) => {
        const [o, h] = a.useState("people");
        let t = i[o];

        function v(l) {
            let s = i.history.filter(r => r !== l);
            i.history.length < 60 && s.unshift(l), i.history = s, localStorage.setItem("emojiHistory", i.history.join(",")), e(l)
        }

        function n(l, s) {
            h(l), s.stopPropagation()
        }
        const z = S.map(l => {
                let s = l.key === o ? "active emoji-icon" : "emoji-icon";
                return c.jsx("div", {
                    className: s,
                    onClick: r => {
                        n(l.key, r)
    ...
    I = w.memo(({
        ...
        const [h, t] = a.useState(!1), v = j(() => t(!1));
